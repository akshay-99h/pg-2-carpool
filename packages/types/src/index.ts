...
export const tripRequestStatusSchema = z.enum(['PENDING', 'CONFIRMED', 'REJECTED']);

export const updateTripRequestSchema = z.object({
  requestId: z.string().uuid(),
  status: tripRequestStatusSchema,
});
...
export type PoolRequestInput = z.infer<typeof poolRequestSchema>;
